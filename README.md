...
### [v1.0.20] - 2026-05-24
* **키보드 백라이트 끄기 강제 커밋 기능 추가**: mac-hardware-toys(KBPulse)와 동일한 메커니즘을 적용하여 `setBrightness:fadeSpeed:commit:forKeyboard:` API를 도입했습니다. 디스플레이가 꺼진 시점에 키보드 조명이 물리적으로 즉각적이고 확실하게(0.0) 꺼지도록 `commit: true`로 설정하여 변경사항을 강제 반영했습니다.
